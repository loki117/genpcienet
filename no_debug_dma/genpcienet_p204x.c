...
static int __init pciedev_probe(struct pci_dev *pci_dev, const struct pci_device_id *pci_id)
{
		...
		(tmp_pcidev->funcnum == funcnum))
	{
		...
		control0_pic = (struct pic_regs *)ioremap(0xffe000000 + 0x50580 , 8);//p204x IIVPR12 
		//control0_pic = (struct pic_regs *)ioremap(0xfffe00000 + 0x50280 , 8);//p2020 IIVPR4
		...
		//DMA1_MR0 地址
		control0_regs=(struct fsldma_regs *)ioremap(0xffe000000 + 0x10000 + 0x100, 0x24);
		//control0_regs=(struct fsldma_regs *)ioremap(0xfffe00000 + 0x21000 + 0x100, 0x24);//p2020
		...
		control0_channel1_pic =(struct pic_regs *)ioremap(0xffe000000 + 0x503a0 , 8);//p204x IIVPR13 //control0_channel1_pic =(struct pic_regs *)ioremap(0xfffe00000 + 0x502a0 , 8);//p2020 IIVPR5
		...
		//DMA1_MR1 地址
		control0_channel1_regs=(struct fsldma_regs *)ioremap(0xffe000000 + 0x10000 + 0x180, 0x24);//control0_channel1_regs=(struct fsldma_regs *)ioremap(0xfffe00000 + 0x21000 + 0x180, 0x24);//p2020
		...
		control1_pic =(struct pic_regs *)ioremap(0xffe000000 + 0x50400 , 8);//p204x IIVPR16 
		//control1_pic =(struct pic_regs *)ioremap(0xfffe00000 + 0x50980 , 8);//p2020 IIVPR60
		...
		//DMA2_MR0
		control1_regs=(struct fsldma_regs *)ioremap(0xffe000000 + 0x101000 + 0x100, 0x24);
		//control1_regs=(struct fsldma_regs *)ioremap(0xfffe00000 + 0xc000 + 0x100, 0x24);//p2020
...
static int __init pciedev_init_module(void)
{
	...
	pcie_dev_class = class_create(THIS_MODULE, "pcie_dev_class");
